...
import { showAllAuthors } from '../pages/authors'; // Adjust the import to your function
describe('getAuthorList', () => {
    ...
    it('should return an empty array when no authors are found', async () => {
        // Arrange: Mock the find method to return an empty list
        const mockFind = jest.fn().mockReturnValue({
    ...
    it('should handle authors with no first name or family name', async () => {
        // Define authors with missing first or family name
        const sortedAuthors = [
            {
                first_name: '',
                family_name: 'Austen',
        ...
        // Assert: Check if the result matches the expected sorted output with missing names
        const expectedAuthors = [
            ' : 1775 - 1817',
            ' : 1835 - 1910',
            ' : 1812 - 1870'
